...
public class FileManager {
    ...
    private final Basics plugin = Basics.instance();

    public void generateConfig() throws IOException, InvalidConfigurationException, FileNotFoundException {
        this.config = new File(this.plugin.getDataFolder(), "config.yml");
        if(!this.config.exists()){
            this.config.getParentFile().mkdirs();
            this.plugin.saveResource("config.yml",false);
            Basics.instance().getServer().getConsoleSender().sendMessage(ChatColor.GREEN.toString() + "Successfully generated the CONFIG.YML file.");
        }
    ...
    public void generateConfigOver() throws IOException, InvalidConfigurationException, FileNotFoundException {
        this.config = new File(this.plugin.getDataFolder(), "config.yml");
        if(this.config.exists()){
            this.config.getParentFile().mkdirs();
    ...
    public void generateData() throws IOException, InvalidConfigurationException, FileNotFoundException{
        this.data = new File(this.plugin.getDataFolder(), "data.yml");
        if(!this.data.exists()){
            this.data.getParentFile().mkdirs();
            this.plugin.saveResource("data.yml",false);
            Basics.instance().getServer().getConsoleSender().sendMessage(ChatColor.GREEN.toString() + "Successfully generated the DATA.YML file.");
        }
        d = new YamlConfiguration();
        d.load(data);
    }

    public void generateMessagesOver() throws IOException, InvalidConfigurationException, FileNotFoundException{
        ...
        if(this.messages.exists()){
            ...
            Basics.instance().getServer().getConsoleSender().sendMessage(ChatColor.GREEN.toString() + "Successfully generated the MESSAGES.YML file.");
        }
    ...
    public void generateMessages() throws IOException, InvalidConfigurationException, FileNotFoundException{
        this.messages = new File(this.plugin.getDataFolder(), "messages.yml");
        if(!this.messages.exists()){
            this.messages.getParentFile().mkdirs();
    ...
    public void saveConfig() {
        try {
            c.save(config);
            update(Basics.instance(), "config.yml", new File(Basics.instance().getDataFolder(), "config.yml"), Collections.emptyList());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void saveMessages() {
        try {
            m.save(messages);
            update(Basics.instance(), "messages.yml", new File(Basics.instance().getDataFolder(), "messages.yml"), Arrays.asList());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
